              ...
              child: CustomScrollView(
                slivers: [
                  SliverPaginatedListView<TvShow>(
                    getItemsCb: (ref, page) => ref.watch(popularTvShowsProvider(page: page)),
                    isNextPageLoadedCb: (ref, page) => ref.exists(popularTvShowsProvider(page: page + 1)),
                    onErrorRetryCb: (ref, page) async => ref.invalidate(popularTvShowsProvider(page: page)),
