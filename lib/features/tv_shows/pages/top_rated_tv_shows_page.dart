              ...
              child: CustomScrollView(
                slivers: [
                  SliverPaginatedListView<TvShow>(
                    getItemsCb: (ref, page) => ref.watch(topRatedTvShowsProvider(page: page)),
                    isNextPageLoadedCb: (ref, page) => ref.exists(topRatedTvShowsProvider(page: page + 1)),
                    onErrorRetryCb: (ref, page) async => ref.invalidate(topRatedTvShowsProvider(page: page)),
