              ...
              child: CustomScrollView(
                slivers: [
                  SliverPaginatedListView<TvShow>(
                    getItemsCb: (ref, page) => ref.watch(onTheAirTvShowsProvider(page: page)),
                    isNextPageLoadedCb: (ref, page) => ref.exists(onTheAirTvShowsProvider(page: page + 1)),
                    onErrorRetryCb: (ref, page) async => ref.invalidate(onTheAirTvShowsProvider(page: page)),
