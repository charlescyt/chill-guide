              ...
              child: CustomScrollView(
                slivers: [
                  SliverPaginatedListView<Movie>(
                    getItemsCb: (ref, page) => ref.watch(topRatedMoviesProvider(page: page)),
                    isNextPageLoadedCb: (ref, page) => ref.exists(topRatedMoviesProvider(page: page + 1)),
                    onErrorRetryCb: (ref, page) async => ref.invalidate(topRatedMoviesProvider(page: page)),
