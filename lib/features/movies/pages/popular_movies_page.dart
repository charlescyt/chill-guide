              ...
              child: CustomScrollView(
                slivers: [
                  SliverPaginatedListView<Movie>(
                    getItemsCb: (ref, page) => ref.watch(popularMoviesResponseProvider(page: page)),
                    isNextPageLoadedCb: (ref, page) => ref.exists(popularMoviesResponseProvider(page: page + 1)),
                    onErrorRetryCb: (ref, page) async => ref.invalidate(popularMoviesResponseProvider(page: page)),
