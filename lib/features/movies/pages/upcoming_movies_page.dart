              ...
              child: CustomScrollView(
                slivers: [
                  SliverPaginatedListView<Movie>(
                    getItemsCb: (ref, page) => ref.watch(upcomingMoviesProvider(page: page)),
                    isNextPageLoadedCb: (ref, page) => ref.exists(upcomingMoviesProvider(page: page + 1)),
                    onErrorRetryCb: (ref, page) async => ref.invalidate(upcomingMoviesProvider(page: page)),
